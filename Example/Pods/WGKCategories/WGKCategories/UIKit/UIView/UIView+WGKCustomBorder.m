...
@implementation UIView (WGKCustomBorder)
...
- (void)wgk_addTopBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self wgk_addTopBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)wgk_addLeftBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self wgk_addLeftBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)wgk_addBottomBorderWithColor:(UIColor *)color width:(CGFloat) borderWidth {
    [self wgk_addBottomBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)wgk_addRightBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self wgk_addRightBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}
...
- (void)wgk_addTopBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth excludePoint:(CGFloat)point edgeType:(WGKExcludePoint)edge {
    ...
    if (edge & WGKExcludeStartPoint) {
        startPoint += point;
    }
    
    if (edge & WGKExcludeEndPoint) {
        endPoint += point;
    }
