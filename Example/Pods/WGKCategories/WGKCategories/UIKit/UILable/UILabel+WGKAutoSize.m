...
@implementation UILabel (WGKAutoSize)
-(UILabel *)wgk_resizeLabelHorizontal{
    return [self wgk_resizeLabelHorizontal:0];
}

- (UILabel *)wgk_resizeLabelVertical{
    return [self wgk_resizeLabelVertical:0];
}

- (UILabel *)wgk_resizeLabelVertical:(CGFloat)minimumHeigh{
...
- (UILabel *)wgk_resizeLabelHorizontal:(CGFloat)minimumWidth{
    CGRect newFrame = self.frame;
