...
@implementation UILabel (WGKAdjustableLabel)


// General method. If minSize is set to CGSizeZero then
// it is ignored.
// =====================================================
- (void)wgk_adjustLabelToMaximumSize:(CGSize)maxSize
...
- (void)wgk_adjustLabelToMaximumSize:(CGSize)maxSize
                 minimumFontSize:(int)minFontSize
{
  [self wgk_adjustLabelToMaximumSize:maxSize
...
// =====================================================
- (void)wgk_adjustLabelSizeWithMinimumFontSize:(int)minFontSize
{
  [self wgk_adjustLabelToMaximumSize:CGSizeZero
                     minimumSize:CGSizeZero 
                 minimumFontSize:minFontSize];
}
