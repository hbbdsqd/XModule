...
typedef NS_ENUM(NSInteger, WGKImagePosition) {
...
@interface UIButton (WGKImagePosition)
 ...
 */
- (void)wgk_setImagePosition:(WGKImagePosition)postion spacing:(CGFloat)spacing;
