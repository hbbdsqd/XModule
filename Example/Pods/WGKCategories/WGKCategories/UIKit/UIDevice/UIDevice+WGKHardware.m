...
@implementation UIDevice (WGKHardware)
...
+ (NSString *)wgk_platformString{
    NSString *platform = [self wgk_platform];
...
+ (NSUInteger)wgk_getSysInfo:(uint)typeSpecifier
{
...
+ (NSUInteger)wgk_cpuFrequency {
    return [self wgk_getSysInfo:HW_CPU_FREQ];
}

+ (NSUInteger)wgk_busFrequency {
    return [self wgk_getSysInfo:HW_BUS_FREQ];
}

+ (NSUInteger)wgk_ramSize {
    return [self wgk_getSysInfo:HW_MEMSIZE];
}

+ (NSUInteger)wgk_cpuNumber {
    return [self wgk_getSysInfo:HW_NCPU];
}


+ (NSUInteger)wgk_totalMemoryBytes
{
    return [self wgk_getSysInfo:HW_PHYSMEM];
}
