...
@implementation UIImageView (WGKGeometryConversion)

- (CGPoint)wgk_convertPointFromImage:(CGPoint)imagePoint {
...
- (CGRect)wgk_convertRectFromImage:(CGRect)imageRect {
    CGPoint imageTopLeft     = imageRect.origin;
    CGPoint imageBottomRight = CGPointMake(CGRectGetMaxX(imageRect),
                                          CGRectGetMaxY(imageRect));
    
    CGPoint viewTopLeft     = [self wgk_convertPointFromImage:imageTopLeft];
    CGPoint viewBottomRight = [self wgk_convertPointFromImage:imageBottomRight];
...
- (CGPoint)wgk_convertPointFromView:(CGPoint)viewPoint {
...
- (CGRect)wgk_convertRectFromView:(CGRect)viewRect {
    CGPoint viewTopLeft = viewRect.origin;
    CGPoint viewBottomRight = CGPointMake(CGRectGetMaxX(viewRect), 
                                          CGRectGetMaxY(viewRect));
    
    CGPoint imageTopLeft = [self wgk_convertPointFromView:viewTopLeft];
    CGPoint imageBottomRight = [self wgk_convertPointFromView:viewBottomRight];
