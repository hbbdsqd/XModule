...
@implementation UIFont (WGKDynamicFontControl)

+(UIFont *)wgk_preferredFontForTextStyle:(NSString *)style withFontName:(NSString *)fontName{
    return [UIFont wgk_preferredFontForTextStyle:style withFontName:fontName scale:1.0f];
}

+(UIFont *)wgk_preferredFontForTextStyle:(NSString *)style withFontName:(NSString *)fontName scale:(CGFloat)scale{
    ...
    return [font wgk_adjustFontForTextStyle:style];

}

-(UIFont *)wgk_adjustFontForTextStyle:(NSString *)style{
    return [self wgk_adjustFontForTextStyle:style scale:1.0f];
}

-(UIFont *)wgk_adjustFontForTextStyle:(NSString *)style scale:(CGFloat)scale{
