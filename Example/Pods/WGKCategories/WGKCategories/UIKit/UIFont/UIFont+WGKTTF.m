...
@implementation UIFont (WGKTTF)

+ (UIFont *)wgk_fontWithTTFAtURL:(NSURL *)URL size:(CGFloat)size{
	...
	return [UIFont wgk_fontWithTTFAtPath:URL.path size:size];
}

+ (UIFont *)wgk_fontWithTTFAtPath:(NSString *)path size:(CGFloat)size{
