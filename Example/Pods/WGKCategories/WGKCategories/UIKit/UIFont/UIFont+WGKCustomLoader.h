 ...
 */
@interface UIFont (WGKCustomLoader)
 ...
 */
+ (UIFont *)wgk_customFontOfSize:(CGFloat)size withName:(NSString *)name withExtension:(NSString *)extension  __attribute__ ((deprecated));
