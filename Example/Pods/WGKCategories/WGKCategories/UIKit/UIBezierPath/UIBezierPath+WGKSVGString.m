...
static void WGKSVGApplier(void* info, const CGPathElement* element);
...
- (NSString*)wgk_SVGString
{
    ...
    CGPathApply(path, (__bridge_retained void*)SVGString, WGKSVGApplier);
    NSString *lineCap;
