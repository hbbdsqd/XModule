...
typedef struct WGKBezierSubpath {
    CGPoint startPoint;
...
@implementation UIBezierPath (WGKLength)
...
- (void)extractSubpaths:(WGKBezierSubpath*)subpathArray
{
...
- (CGPoint)pointAtPercent:(CGFloat)t ofSubpath:(WGKBezierSubpath)subpath {
...
- (CGFloat)wgk_length {
	...
	WGKBezierSubpath subpaths[subpathCount];
...
- (CGPoint)wgk_pointAtPercentOfLength:(CGFloat)percent {
    ...
    WGKBezierSubpath subpathContainingPoint;
	for (NSUInteger i = 0; i < subpathCount; i++) {
