...
@interface UISplitViewController (WGKQuickAccess)

@property (weak, readonly, nonatomic) UIViewController *wgk_leftController;
@property (weak, readonly, nonatomic) UIViewController *wgk_rightController;
