...
@implementation NSString (WGKScore)

- (CGFloat)wgk_scoreAgainst:(NSString *)otherString{
    return [self wgk_scoreAgainst:otherString fuzziness:nil];
}

- (CGFloat)wgk_scoreAgainst:(NSString *)otherString fuzziness:(NSNumber *)fuzziness{
    return [self wgk_scoreAgainst:otherString fuzziness:fuzziness options:NSStringWGKScoreOptionNone];
}

- (CGFloat)wgk_scoreAgainst:(NSString *)anotherString fuzziness:(NSNumber *)fuzziness options:(NSStringWGKScoreOption)options{
    ...
    if(NSStringWGKScoreOptionFavorSmallerWords == (options & NSStringWGKScoreOptionFavorSmallerWords)){
    ...
    if(NSStringWGKScoreOptionReducedLongStringPenalty == (options & NSStringWGKScoreOptionReducedLongStringPenalty)){
