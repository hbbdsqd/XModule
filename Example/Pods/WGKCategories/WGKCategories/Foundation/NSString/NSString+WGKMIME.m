...
@implementation NSString (WGKMIME)
/**
...
- (NSString *)wgk_MIMEType {
    return [[self class] wgk_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)wgk_MIMETypeForExtension:(NSString *)extension {
    return [[self wgk_MIMEDict] valueForKey:[extension lowercaseString]];
}
/**
 *  @brief  常见MIME集合
 *
