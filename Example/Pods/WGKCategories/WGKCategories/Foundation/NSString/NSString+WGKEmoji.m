...
@implementation NSString (WGKEmoji)

static NSDictionary * wgk_s_unicodeToCheatCodes = nil;
static NSDictionary * wgk_s_cheatCodesToUnicode = nil;

+ (void)wgk_initializeEmojiCheatCodes
{
    ...
    @synchronized(self) {
        wgk_s_unicodeToCheatCodes = forwardMap;
        wgk_s_cheatCodesToUnicode = [reversedMap copy];
    }
}

- (NSString *)wgk_stringByReplacingEmojiCheatCodesWithUnicode
{
    if (!wgk_s_cheatCodesToUnicode) {
        [NSString wgk_initializeEmojiCheatCodes];
    }
    
    if ([self rangeOfString:@":"].location != NSNotFound) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [wgk_s_cheatCodesToUnicode enumerateKeysAndObjectsUsingBlock:^(NSString *key, id obj, BOOL *stop) {
...
- (NSString *)wgk_stringByReplacingEmojiUnicodeWithCheatCodes
{
    ...
    if (self.length) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [wgk_s_unicodeToCheatCodes enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
