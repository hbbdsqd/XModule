...
- (NSData *)wgk_hmacMD5DataWithKey:(NSData *)key {
    return [self wgk_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}
/**
 *  @brief  sha1Data NSData
 *
...
{
    return [self wgk_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}
/**
 *  @brief  sha256Data NSData
 *
...
{
    return [self wgk_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}
/**
 *  @brief  sha512Data NSData
 *
...
{
    return [self wgk_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}


- (NSData *)wgk_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
