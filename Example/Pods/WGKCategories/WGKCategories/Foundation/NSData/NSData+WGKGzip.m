...
@implementation NSData (WGKGzip)

static void *wgk_libzOpen()
{
    static void *libz;
...
{
    if (self.length == 0 || [self wgk_isGzippedData])
    {
        return self;
    }
    
    void *libz = wgk_libzOpen();
...
{
    return [self wgk_gzippedDataWithCompressionLevel:-1.0f];
}
