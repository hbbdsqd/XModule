...
@implementation NSMutableURLRequest (WGKUpload)

+ (instancetype)wgk_requestWithURL:(NSURL *)URL fileURL:(NSURL *)fileURL name:(NSString *)name {
    return [self wgk_requestWithURL:URL fileURLs:@[fileURL] name:name];
}

+ (instancetype)wgk_requestWithURL:(NSURL *)URL fileURL:(NSURL *)fileURL fileName:(NSString *)fileName name:(NSString *)name {
    return [self wgk_requestWithURL:URL fileURLs:@[fileURL] fileNames:@[fileName] name:name];
}

+ (instancetype)wgk_requestWithURL:(NSURL *)URL fileURLs:(NSArray *)fileURLs name:(NSString *)name {
    ...
    return [self wgk_requestWithURL:URL fileURLs:fileURLs fileNames:fileNames name:name];
}

+ (instancetype)wgk_requestWithURL:(NSURL *)URL fileURLs:(NSArray *)fileURLs fileNames:(NSArray *)fileNames name:(NSString *)name {
