...
@implementation NSDecimalNumber (WGKCalculatingByString)

+ (NSDecimalNumber *)wgk_decimalNumberWithEquation:(NSString *)equation decimalNumbers:(NSDictionary *)numbers
{
