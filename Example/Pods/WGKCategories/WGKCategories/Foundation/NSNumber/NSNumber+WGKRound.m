...
@implementation NSNumber (WGKRound)
#pragma mark - Display
- (NSString*)wgk_toDisplayNumberWithDigit:(NSInteger)digit
{
    NSString *result = nil;
...
- (NSString*)wgk_toDisplayPercentageWithDigit:(NSInteger)digit
{
    NSString *result = nil;
    NSNumberFormatter *formatter = [[NSNumberFormatter alloc] init];
 ...
 *  @return 结果
 */
- (NSNumber*)wgk_doRoundWithDigit:(NSUInteger)digit
{
    NSNumber *result = nil;
    NSNumberFormatter *formatter = [[NSNumberFormatter alloc] init];
    [formatter setRoundingMode:NSNumberFormatterRoundHalfUp];
 ...
 *  @return 结果
 */
- (NSNumber*)wgk_doCeilWithDigit:(NSUInteger)digit
{
    NSNumber *result = nil;
    NSNumberFormatter *formatter = [[NSNumberFormatter alloc] init];
 ...
 *  @return 结果
 */
- (NSNumber*)wgk_doFloorWithDigit:(NSUInteger)digit
{
    NSNumber *result = nil;
    NSNumberFormatter *formatter = [[NSNumberFormatter alloc] init];
