...
@interface NSRunLoop (WGKPerformBlock)
/**
 *  @author ishkawa
 *
 ...
 */
- (void)wgk_performBlockAndWait:(void (^)(BOOL *finish))block;
/**
 *  @author ishkawa
 *
 *  @brief   extension of NSRunLoop for waiting.
 ...
 *  @param block <#block description#>
 */
- (void)wgk_performBlockAndWait:(void (^)(BOOL *finish))block timeoutInterval:(NSTimeInterval)timeoutInterval;
