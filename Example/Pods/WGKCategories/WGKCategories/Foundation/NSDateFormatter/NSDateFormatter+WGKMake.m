...
@implementation NSDateFormatter (WGKMake)

+(NSDateFormatter *)wgk_dateFormatterWithFormat:(NSString *)format {
    return [self wgk_dateFormatterWithFormat:format timeZone:nil];
}

+(NSDateFormatter *)wgk_dateFormatterWithFormat:(NSString *)format timeZone:(NSTimeZone *)timeZone {
    return [self wgk_dateFormatterWithFormat:format timeZone:timeZone locale:nil];
}
...
+(NSDateFormatter *)wgk_dateFormatterWithDateStyle:(NSDateFormatterStyle)style {
    return [self wgk_dateFormatterWithDateStyle:style timeZone:nil];
}
...
+(NSDateFormatter *)wgk_dateFormatterWithTimeStyle:(NSDateFormatterStyle)style {
    return [self wgk_dateFormatterWithTimeStyle:style timeZone:nil];
}
