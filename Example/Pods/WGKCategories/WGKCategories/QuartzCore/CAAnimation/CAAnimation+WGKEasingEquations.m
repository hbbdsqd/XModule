...
@implementation CAAnimation (WGKEasingEquations)
...
+ (CAKeyframeAnimation*)wgk_transformAnimationWithDuration:(CGFloat)duration
...
+ (void)wgk_addAnimationToLayer:(CALayer *)layer
                   duration:(CGFloat)duration
                  transform:(CATransform3D)transform
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self wgk_transformAnimationWithDuration:duration
...
+ (CAKeyframeAnimation*)wgk_animationWithKeyPath:(NSString*)keyPath
                                    duration:(CGFloat)duration
...
+ (void)wgk_addAnimationToLayer:(CALayer *)layer
             ...
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    [self wgk_addAnimationToLayer:layer
                  withKeyPath:keyPath
                     duration:duration
...
+ (void)wgk_addAnimationToLayer:(CALayer *)layer
             ...
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self wgk_animationWithKeyPath:keyPath
                                               duration:duration
                                                   from:startValue
                                                     to:endValue
                                         easingFunction:easingFunction];
