...
@implementation NSManagedObjectContext(WGKExtensions)

- (NSManagedObjectModel *)wgk_objectModel
{
...
{
  return [self wgk_fetchObjectsForEntity:entity predicate:nil sortDescriptors:nil];
}

- (NSArray *)wgk_fetchObjectsForEntity:(NSString *)entity predicate:(NSPredicate *)predicate
{
  return [self wgk_fetchObjectsForEntity:entity predicate:predicate sortDescriptors:nil];
}

- (NSArray *)wgk_fetchObjectsForEntity:(NSString *)entity sortDescriptors:(NSArray *)sortDescriptors
{
  return [self wgk_fetchObjectsForEntity:entity predicate:nil sortDescriptors:sortDescriptors];
}
...
- (NSArray *)wgk_fetchObjectsForEntity:(NSString *)entity predicate:(NSPredicate *)predicate sortDescriptors:(NSArray *)sortDescriptors {
  return [self wgk_fetchObjectsForEntity:entity predicate:predicate sortDescriptors:sortDescriptors fetchLimit:0];
}
...
{
  NSFetchRequest *request = [NSFetchRequest wgk_fetchRequestWithEntity:[NSEntityDescription entityForName:entity inManagedObjectContext:self] predicate:predicate sortDescriptors:sortDescriptors];
  if (limit > 0)
...
{
  return [self wgk_fetchObjectForEntity:entity predicate:nil sortDescriptors:nil];
}

- (id)wgk_fetchObjectForEntity:(NSString *)entity predicate:(NSPredicate *)predicate
{
  return [self wgk_fetchObjectForEntity:entity predicate:predicate sortDescriptors:nil];
}

- (id)wgk_fetchObjectForEntity:(NSString *)entity sortDescriptors:(NSArray *)sortDescriptors
{
  return [self wgk_fetchObjectForEntity:entity predicate:nil sortDescriptors:sortDescriptors];
}

- (id)wgk_fetchObjectForEntity:(NSString *)entity predicate:(NSPredicate *)predicate sortDescriptors:(NSArray *)sortDescriptors
{
  NSArray *results = [self wgk_fetchObjectsForEntity:entity predicate:predicate sortDescriptors:sortDescriptors];
  if (results.count < 1)
    return nil;
...
{
  [self wgk_fetchObjectsForEntity:entity predicate:nil sortDescriptors:nil callback:callback];
}

- (void)wgk_fetchObjectsForEntity:(NSString *)entity predicate:(NSPredicate *)predicate callback:(FetchObjectsCallback)callback
{
  [self wgk_fetchObjectsForEntity:entity predicate:predicate sortDescriptors:nil callback:callback];
}
...
{
  [self wgk_fetchObjectsForEntity:entity predicate:nil sortDescriptors:sortDescriptors callback:callback];
}
...
- (void)wgk_fetchObjectsForEntity:(NSString *)entity predicate:(NSPredicate *)predicate sortDescriptors:(NSArray *)sortDescriptors callback:(FetchObjectsCallback)callback
{
  ...
  [self wgk_fetchRequest:request withCallback:callback];
}

- (void)wgk_fetchObjectForEntity:(NSString *)entity callback:(FetchObjectCallback)callback
{
  [self wgk_fetchObjectForEntity:entity predicate:nil sortDescriptors:nil callback:callback];
}

- (void)wgk_fetchObjectForEntity:(NSString *)entity predicate:(NSPredicate *)predicate callback:(FetchObjectCallback)callback
{
  [self wgk_fetchObjectForEntity:entity predicate:predicate sortDescriptors:nil callback:callback];
}
...
{
  [self wgk_fetchObjectForEntity:entity predicate:nil sortDescriptors:sortDescriptors callback:callback];
}
...
{
  [self wgk_fetchObjectsForEntity:entity predicate:predicate sortDescriptors:sortDescriptors callback:^(NSArray *objects, NSError *error) {
    id object = nil;
...
- (void)wgk_deleteEntity:(NSString *)entity withPredicate:(NSPredicate *)predicate
{
  ...
  NSFetchRequest *fetchRequest = [NSFetchRequest wgk_fetchRequestWithEntity:[NSEntityDescription entityForName:entity inManagedObjectContext:self] predicate:predicate];
